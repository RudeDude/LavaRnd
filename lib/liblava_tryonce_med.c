/*
 * liblava_tryonce_med - callback to use s100 of high/med quality after 1st err
 *
 ...
 *
 * @(#) $Revision: 10.1 $
 * @(#) $Id: liblava_tryonce_med.c,v 10.1 2003/08/18 06:44:37 lavarnd Exp $
 *
 ...
 */
lavaback lava_callback = LAVACALL_TRYONCE_MED;
