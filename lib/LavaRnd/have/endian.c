 ...
 *
 * @(#) $Revision: 10.1 $
 * @(#) $Id: endian.c,v 10.1 2003/08/18 06:44:37 lavarnd Exp $
 * @(#) $Source: /home/lavarnd/int/lib/LavaRnd/have/RCS/endian.c,v $
 *
...
main(void)
{
    ...
    printf("#if !defined(BIG_ENDIAN)\n");
    printf("# define BIG_ENDIAN\t4321\n");
    printf("#endif\n");
    printf("#if !defined(LITTLE_ENDIAN)\n");
