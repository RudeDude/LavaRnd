...
# This allows declaration	use LavaRnd::Retry ':all';
...
require XSLoader;
XSLoader::load('LavaRnd::Retry', $VERSION);
...
LavaRnd::Retry - use LavaRnd lavapool, retry lavapool on error

=head1 SYNOPSIS

  use LavaRnd::Retry qw(
    random8 random16 random32 random_data
    random_val random_coin
    range_drandom range_dcrandom
    drandom dcrandom
  ...
  # Error checking
  #
  # NOTE: This LavaRnd::Retry module will exit instead of returning
...
the this module will retry the connection.
Thus, every return value from this module is
cryptographically strong random numbers.
On the other hand, a dead or unreachable lavapool daemon
could hang the caller for a long time.

This module uses the LavaRnd liblava_retry.a library.
