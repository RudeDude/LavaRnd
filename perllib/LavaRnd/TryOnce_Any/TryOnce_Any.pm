...
# This allows declaration	use LavaRnd::TryOnce_Any ':all';
...
require XSLoader;
XSLoader::load('LavaRnd::TryOnce_Any', $VERSION);
...
LavaRnd::TryOnce_Any - use LavaRnd lavapool or any s100 quality after 1st error

=head1 SYNOPSIS

  use LavaRnd::TryOnce_Any qw(
    random8 random16 random32 random_data
    random_val random_coin
    range_drandom range_dcrandom
    drandom dcrandom
  ...
  # Error checking
  #
  # NOTE: This LavaRnd::TryOnce_Any module will exit instead of returning
...
a local s100 generator takes over.
Unlike LavaRnd::Try_Any, this module will continue to
use the local s100 generator after the first failure to
communicate with the lavapool daemon.
...
This module uses the LavaRnd liblava_tryonce_any.a library.
